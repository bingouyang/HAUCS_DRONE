...
# variables
SEND_ORDER = ["time","do", "temp", "press","init_DO","init_pressure"]
# will pad init_DO and init_pressure to same length as the actual data.
VAR_MAP = {"time": [], "do": [], "temp": [], "press": [], "init_DO":[],"init_pressure":[]}
...
def save_buffer(failed: dict, path: str = "outbox.json") -> None:
